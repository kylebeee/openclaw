...
read_when:
  ...
  - Wiring external systems into OpenHearth
title: "Webhooks"
---
...
- `openhearth webhooks gmail setup` writes `hooks.gmail` config for `openhearth webhooks gmail run`.
