...
import { type OpenHearthConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: OpenHearthConfig): string[] {
...
export function listAgentsForGateway(cfg: OpenHearthConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: OpenHearthConfig): string {
...
function resolveSessionStoreAgentId(cfg: OpenHearthConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: OpenHearthConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: OpenHearthConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: OpenHearthConfig): GatewaySessionsDefaults {
