...
import type { OpenHearthConfig, SkillConfig } from "../../config/config.js";
...
export function resolveConfigPath(config: OpenHearthConfig | undefined, pathStr: string) {
...
export function isConfigPathTruthy(config: OpenHearthConfig | undefined, pathStr: string): boolean {
...
export function resolveSkillConfig(
  config: OpenHearthConfig | undefined,
  skillKey: string,
...
const BUNDLED_SOURCES = new Set(["openhearth-bundled"]);

function isBundledSkill(entry: SkillEntry): boolean {
  return BUNDLED_SOURCES.has(entry.skill.source);
}

export function resolveBundledAllowlist(config?: OpenHearthConfig): string[] | undefined {
