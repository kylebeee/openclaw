...
export function listGoogleChatAccountIds(cfg: OpenHearthConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: OpenHearthConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: OpenHearthConfig): ResolvedGoogleChatAccount[] {
