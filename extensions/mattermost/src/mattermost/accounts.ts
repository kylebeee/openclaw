...
export function listMattermostAccountIds(cfg: OpenHearthConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: OpenHearthConfig): string {
...
export function listEnabledMattermostAccounts(cfg: OpenHearthConfig): ResolvedMattermostAccount[] {
