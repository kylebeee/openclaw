---
summary: "Model providers (LLMs) supported by OpenHearth"
read_when:
...
OpenHearth can use many LLM providers. Pick a provider, authenticate, then set the
...
1. Authenticate with the provider (usually via `openhearth onboard`).
