...
function resolveWatchPaths(workspaceDir: string, config?: OpenHearthConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: OpenHearthConfig }) {
