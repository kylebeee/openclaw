...
if [[ -z "$version_content" ]]; then
  echo "<h2>OpenHearth $VERSION</h2>"
  echo "<p>Latest OpenHearth update.</p>"
  echo "<p><a href=\"https://github.com/kylebeee/openhearth/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
