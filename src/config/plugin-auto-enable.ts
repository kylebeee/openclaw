...
function isTelegramConfigured(cfg: OpenHearthConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: OpenHearthConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: OpenHearthConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: OpenHearthConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: OpenHearthConfig): boolean {
...
function isIMessageConfigured(cfg: OpenHearthConfig): boolean {
...
function isWhatsAppConfigured(cfg: OpenHearthConfig): boolean {
...
function isGenericChannelConfigured(cfg: OpenHearthConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: OpenHearthConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: OpenHearthConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: OpenHearthConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: OpenHearthConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: OpenHearthConfig, pluginId: string): OpenHearthConfig {
...
function registerPluginEntry(cfg: OpenHearthConfig, pluginId: string): OpenHearthConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
