...
function listConfiguredAccountIds(cfg: OpenHearthConfig): string[] {
...
export function listZaloAccountIds(cfg: OpenHearthConfig): string[] {
...
export function resolveDefaultZaloAccountId(cfg: OpenHearthConfig): string {
...
function mergeZaloAccountConfig(cfg: OpenHearthConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: OpenHearthConfig): ResolvedZaloAccount[] {
