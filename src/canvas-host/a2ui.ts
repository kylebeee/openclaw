...
export const A2UI_PATH = "/__openhearth__/a2ui";

export const CANVAS_HOST_PATH = "/__openhearth__/canvas";

export const CANVAS_WS_PATH = "/__openhearth__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.openhearthCanvasA2UIAction.postMessage(...)
  // - Android: window.openhearthCanvasA2UIAction.postMessage(...)
  const handlerNames = ["openhearthCanvasA2UIAction"];
  ...
  globalThis.OpenHearth = globalThis.OpenHearth ?? {};
  globalThis.OpenHearth.postMessage = postToNode;
  globalThis.OpenHearth.sendUserAction = sendUserAction;
  globalThis.openhearthPostMessage = postToNode;
  globalThis.openhearthSendUserAction = sendUserAction;
