...
const STATE_FILE_PATH = join(CONFIG_BASE_DIR, "openhearth", STATE_FILE_NAME);
      ...
      input: [
        {
          role: "system",
          content:
            "You classify GitHub issues and pull requests for OpenHearth. Respond with JSON only, no extra text.",
        },
        {
          role: "user",
          content: [
...
async function main() {
  ...
  logHeader("OpenHearth Issue Label Audit");
