...
// pi-ai's built-in Anthropic catalog can lag behind OpenHearth's defaults/docs.
...
export function buildModelAliasLines(cfg?: OpenHearthConfig) {
...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveOpenHearthAgentDir();
